...
class EvolutionSearcher(object):
    ...
    def __init__(self, args, device, model, model_without_ddp, choices, val_loader, test_loader, output_dir):
        ...
        self.epoch = 0
        self.checkpoint_path = args.resume_1
        self.candidates = []
        self.top_accuracies = []
        self.cand_params = []
...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/datasets01_101/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'EVO_IMNET','UCM','UCM50','NWPU','NWPU10','AID','AID50'],
    ...
    parser.add_argument('--resume_1', default='', help='resume from checkpoint')
